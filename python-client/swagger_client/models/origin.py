...
class Origin(object):
    ...
    def route_idx(self, route_idx):
        """
        Sets the route_idx of this Origin.
        Route index of a stop/station. Can be used as a reference of the stop/station in a journeyDetail response

        :param route_idx: The route_idx of this Origin.
        :type: str
        """
    ...
    def value(self):
        """
        Gets the value of this Origin.

        :return: The value of this Origin.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """
        Sets the value of this Origin.

        :param value: The value of this Origin.
        :type: str
        """
        if value is None:
    ...
    def cancelled(self):
        """
        Gets the cancelled of this Origin.
        Will be set to true if departure/arrival at this stop is cancelled

        :return: The cancelled of this Origin.
        :rtype: bool
        """
    ...
    def cancelled(self, cancelled):
        """
        Sets the cancelled of this Origin.
        Will be set to true if departure/arrival at this stop is cancelled

        :param cancelled: The cancelled of this Origin.
        :type: bool
        """
    ...
    def track(self):
        """
        Gets the track of this Origin.
        Track information, if available

        :return: The track of this Origin.
        :rtype: str
        """
        return self._track
    ...
    def track(self, track):
        """
        Sets the track of this Origin.
        Track information, if available

        :param track: The track of this Origin.
        :type: str
        """
    ...
    def rt_track(self):
        """
        Gets the rt_track of this Origin.
        Realtime track information, if available

        :return: The rt_track of this Origin.
        :rtype: str
        """
    ...
    def rt_track(self, rt_track):
        """
        Sets the rt_track of this Origin.
        Realtime track information, if available

        :param rt_track: The rt_track of this Origin.
        :type: str
        """
    ...
    def date(self):
        """
        Gets the date of this Origin.
        Date in format YYYY-MM-DD

        :return: The date of this Origin.
        :rtype: date
        """
        return self._date
    ...
    def date(self, date):
        """
        Sets the date of this Origin.
        Date in format YYYY-MM-DD

        :param date: The date of this Origin.
        :type: date
        """
        if date is None:
    ...
    def notes(self):
        """
        Gets the notes of this Origin.

        :return: The notes of this Origin.
        :rtype: Notes
        """
        return self._notes
    ...
    def notes(self, notes):
        """
        Sets the notes of this Origin.

        :param notes: The notes of this Origin.
        :type: Notes
        """
    ...
    def rt_date(self):
        """
        Gets the rt_date of this Origin.
        Realtime date in format YYYY-MM-DD, if available

        :return: The rt_date of this Origin.
        :rtype: date
        """
    ...
    def rt_date(self, rt_date):
        """
        Sets the rt_date of this Origin.
        Realtime date in format YYYY-MM-DD, if available

        :param rt_date: The rt_date of this Origin.
        :type: date
        """
    ...
    def time(self):
        """
        Gets the time of this Origin.
        Time in format HH:MM

        :return: The time of this Origin.
        :rtype: str
        """
        return self._time
    ...
    def time(self, time):
        """
        Sets the time of this Origin.
        Time in format HH:MM

        :param time: The time of this Origin.
        :type: str
        """
        if time is None:
    ...
    def directdate(self):
        """
        Gets the directdate of this Origin.
        Date in format YYYY-MM-DD.  Based on the direct travel time

        :return: The directdate of this Origin.
        :rtype: date
        """
    ...
    def directdate(self, directdate):
        """
        Sets the directdate of this Origin.
        Date in format YYYY-MM-DD.  Based on the direct travel time

        :param directdate: The directdate of this Origin.
        :type: date
        """
    ...
    def rt_time(self):
        """
        Gets the rt_time of this Origin.
        Realtime time in format HH:MM if available

        :return: The rt_time of this Origin.
        :rtype: str
        """
    ...
    def rt_time(self, rt_time):
        """
        Sets the rt_time of this Origin.
        Realtime time in format HH:MM if available

        :param rt_time: The rt_time of this Origin.
        :type: str
        """
    ...
    def directtime(self):
        """
        Gets the directtime of this Origin.
        Direct Time format HH:MM. Based on the direct travel time

        :return: The directtime of this Origin.
        :rtype: str
        """
    ...
    def directtime(self, directtime):
        """
        Sets the directtime of this Origin.
        Direct Time format HH:MM. Based on the direct travel time

        :param directtime: The directtime of this Origin.
        :type: str
        """
